...
class SpaceRepository
    ...
    def create(space)
        sql = 'INSERT INTO spaces (name, price, description, availability) VALUES ($1, $2,$3, $4);'
        result_set = DatabaseConnection.exec_params(sql, [space.name, space.price, space.description, space.availability])
